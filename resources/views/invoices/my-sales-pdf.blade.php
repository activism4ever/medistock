...
<body>
<div class="header">
  <h1>MediStock POS — Drawer Sales Report</h1>
  <p>Pharmacist: {{ $user->name }} @if($user->drawer_number) | Drawer {{ $user->drawer_number }} @endif</p>
  <div class="meta">
...
<div class="cards">
  ...
  <div class="card green">
    <div class="lbl">Insurance Sales</div>
