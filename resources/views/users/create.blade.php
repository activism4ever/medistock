  ...
  <div class="bg-white rounded-2xl border border-gray-200 p-7">
    <form action="{{ route('users.store') }}" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <select name="role" required class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <div class="flex gap-3 pt-2">
        <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl text-sm font-semibold">Create User</button>
